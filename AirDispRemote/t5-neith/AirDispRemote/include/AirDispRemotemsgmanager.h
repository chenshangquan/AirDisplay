...
/*
	消息处理接口
*/
class IAirDispRemoteMsgManager : public Singleton<IAirDispRemoteMsgManager>
{
public:
	IAirDispRemoteMsgManager(){}
	virtual ~IAirDispRemoteMsgManager(){}
/** 广播消息 
...
template<> IAirDispRemoteMsgManager* Singleton<IAirDispRemoteMsgManager>::ms_pSingleton  = 0;



class CAirDispRemoteMsgManager : public IAirDispRemoteMsgManager
{
public:
	CAirDispRemoteMsgManager(void);
	~CAirDispRemoteMsgManager(void);
