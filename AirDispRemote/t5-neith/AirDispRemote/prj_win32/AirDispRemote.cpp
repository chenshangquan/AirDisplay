...
BEGIN_MESSAGE_MAP(CAirDispRemoteApp, CWinApp)
...
CAirDispRemoteApp::CAirDispRemoteApp()
{
...
BOOL CAirDispRemoteApp::InitInstance()
{
    //只启动一次
    if ( !OnlyStartOne() )
    {   
...
//     CExceptionCatch::Start(); 
    ...
    //创建rkctool session
    CAirDispRemoteComInterface->CreateSession();
...
int CAirDispRemoteApp::ExitInstance()
{
...
BOOL CAirDispRemoteApp::OnlyStartOne()
{
