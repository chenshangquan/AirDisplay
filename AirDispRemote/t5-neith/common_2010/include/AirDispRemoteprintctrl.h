...
{
    emEventTypeOspSend, //Osp Send
    emEventTypeOspRecv, //Osp Recv
};

class CAirDispRemotePrintCtrl  
{  
...
public: 
   ...
   /*=============================================================================
    ...
    =============================================================================*/
    static const CAirDispRemotePrintCtrl*GetPrintCtrl(); 
...
protected:
    ...
    static CAirDispRemotePrintCtrl* m_pPrtCtrl;
